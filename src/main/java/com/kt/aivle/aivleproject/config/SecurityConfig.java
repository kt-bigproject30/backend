...
//                        configuration.setAllowedOrigins(Collections.singletonList("http://localhost:3000"));
                        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "https://draftai.site"));

//                        configuration.setAllowedOrigins(Collections.singletonList("https://draft.site"));
